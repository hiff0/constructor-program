        ...
        >
          ...
          <td>
            <div class="activities rounded-pill h-75 d-flex justify-center align-center">
              <v-icon icon="mdi-comment-text-outline" class="mr-3 action" title=" Комментарий" disabled></v-icon>
              <v-icon icon="mdi-pencil-outline" class="mr-3 action" title="Редактировать"></v-icon>
              <v-icon icon="mdi-trash-can-outline" class="action" title="Удалить" @click="deleteElement(element)"></v-icon>
            </div>
          </td>
        </tr>
        <tr>
